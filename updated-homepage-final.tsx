...
// Fallback banner color if images don't load - Updated with new colors
const bannerFallbacks = [
  "linear-gradient(135deg, #005B96 0%, #1C7AB0 100%)",
...
// -------------------- UPDATED Fixed Header with Book Table --------------------
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          {/* Right Side - Auth, Book Table & Cart */}
          <div className="flex items-center gap-4">
            <Link 
              href="/reserve" 
              className="bg-[#F4A261] text-white px-4 py-2 rounded-lg hover:bg-[#e68e42] transition text-sm font-medium hidden md:block"
            >
              Book a Table
            </Link>
      ...
      <div className="absolute inset-0 bg-black/30 flex items-center justify-center">
        <div className="text-center text-white px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/auth"
              className="border-2 border-white text-white px-6 py-3 rounded-lg hover:bg-white hover:text-[#005B96] transition text-lg font-semibold inline-block"
            >
              Join & Save 20%
            </Link>
          </div>
  ...
  <div className="bg-white rounded-lg shadow-md overflow-hidden hover:scale-105 transition-transform duration-300 group">
    <Link href={link}>
      <div className="relative h-48 w-full">
        <div className="absolute inset-0 bg-gradient-to-br from-[#005B96] to-[#1C7AB0] flex items-center justify-center">
...
// -------------------- Action Buttons Section (View Menu, Book Catering, Reserve Table) --------------------
...
export default function HomePage() {
  ...
  return (
    <PageWrapper>
      <VerticalPromoBanner />
      <main className="min-h-screen bg-[#005B96] text-white">
        <FixedHeader />
        ...
        {/* Features Section - Updated with whitish fade background */}
        <section className="py-16" style={{ backgroundColor: colors.whitishFade }}>
          <div className="max-w-6xl mx-auto px-6">
            <h2 className="text-3xl font-bold text-center text-[#005B96] mb-12">Why Choose Garden & Grains?</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {features.map((feature: any, index) => (
                <div key={index} className="text-center">
                  <div className="text-4xl mb-4">{feature.icon}</div>
                  <h3 className="text-xl font-semibold text-[#005B96] mb-2">{feature.title}</h3>
        ...
        {/* Menu CTA Section - Updated colors */}
        <section className="py-16 px-6 text-center bg-gradient-to-b from-[#FAF7F2] to-[#005B96]">
        ...
        {/* Customer Favorites Section - Updated dark azure */}
        <section className="py-16 px-6" style={{ backgroundColor: colors.darkAzure }}>
          <div className="max-w-6xl mx-auto">
        ...
        <section className="bg-gradient-to-b from-[#FAF7F2] to-[#005B96] text-[#005B96] py-16 px-6 text-center">
          <div className="max-w-4xl mx-auto">
        ...
        {/* Connect Section - Updated dark azure */}
        <section className="bg-gradient-to-r from-[#005B96] to-[#1C7AB0] text-white py-12 px-6 text-center">
          <div className="max-w-4xl mx-auto">
