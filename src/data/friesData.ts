export const fries = [
  ...
  },
  {
    ...
    description: "Crispy sweet potato fries served with a hint of paprika.",
    price: 55,
    image: "/images/fries/sweet-potato-fries.jpg",
    addOns: [
      { name: "Garlic Mayo", price: 12 },
      { name: "Avocado Dip", price: 18 },
    ],
    juiceUpsell: [
      {
        size: "250ml",
  ...
  {
    name: "Loaded Fries",
    description: "Fries topped with melted vegan cheese, jalapeños, and spicy sauce.",
    price: 75,
    image: "/images/fries/loaded-fries.jpg",
    addOns: [
      { name: "Extra Cheese", price: 20 },
      { name: "Extra Jalapeños", price: 10 },
    ],
    juiceUpsell: [
      {
        size: "250ml",
