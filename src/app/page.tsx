  ...
  return (
    ...
    >
      <div className="relative w-full h-full">
        ...
        {/* Nav + Cart - pinned to right corner */}
        <div className="absolute right-4 sm:right-6 md:right-8 top-1/2 -translate-y-1/2 z-30 flex items-center gap-3 sm:gap-4 md:gap-5">
          <Link href="/admin" className="text-white hover:text-[#F4A261] transition font-medium text-xs sm:text-sm md:text-base">Admin</Link>
          ...
          <Link href="/cart" className="relative text-white hover:text-[#F4A261] transition">
            ...
            {itemCount > 0 && (
              <span
                key={itemCount}
                className="absolute -top-2 -right-2 bg-[#F4A261] text-white text-[10px] sm:text-xs rounded-full w-4 sm:w-5 h-4 sm:h-5 flex items-center justify-center animate-bounce"
              >
                {itemCount}
              </span>
            )}
...
// Dynamic Banner Component (uses imported bannerImages)
function DynamicBanner() {
  ...
  return (
    ...
    >
      ...
      {/* Dot indicators with thumbnail previews on hover */}
      <div className="absolute bottom-4 w-full flex justify-center gap-2">
        {bannerImages.map((src, idx) => (
          ...
          >
            ...
            />
            {/* Thumbnail preview (desktop only, lazy-loaded) */}
            {hoveredDot === idx && (
      ...
      <main className="min-h-screen w-screen overflow-x-hidden bg-[#1E4259] text-white">
        ...
        <div className="pt-16 sm:pt-20">
          ...
          <section className="bg-[#FAF7F2] p-6 sm:p-8 rounded-lg text-center mb-12 sm:mb-16 mx-4 text-[#1E4259]">
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-[#6C7B58] mb-2">
              Hosting a Gathering?
            </h2>
            <p className="text-sm sm:text-base text-[#4A665E] mb-4">
              Let us cater your next event with wholesome, crowd-pleasing dishes.
            </p>
          ...
          <section className="text-center mb-12 sm:mb-16">
            ...
            <p className="mt-2 text-xs sm:text-sm text-gray-200">
              Available for self-collection, takeaway, and delivery.
            </p>
          </section>
            ...
            <div className="flex justify-center gap-4 sm:gap-6">
              {[
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-white hover:text-[#F4A261] transition-colors duration-300"
                >
                  {icon}
                </a>
              ))}
