      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Warm, comforting soups made with fresh ingredients and served with artisanal sourdough bread
          </p>
        </div>
              ...
              >
                <div className="relative w-full h-52">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-[#8B4513] to-[#D2691E] hidden items-center justify-center">
                    <span className="text-white/80 text-sm">Soup Image</span>
                  </div>
                ...
                <div className="p-6 flex flex-col gap-2">
                  ...
                  {item.tags && (
                    <div className="flex flex-wrap gap-1 mt-1">
                      {item.tags.filter(tag => tag !== "Popular" && tag !== "Vegetarian").map((tag, index) => (
