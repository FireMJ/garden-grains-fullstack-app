...
export default function SoupsListPage() {
  ...
  // TODO: Replace with actual data import for soups
  const menuItems = [
    {
      id: "1",
      name: "Sample Hearty Soups Item 1",
      description: "Delicious soups item description with fresh ingredients",
      price: 45.00,
      image: "/images/menu/soups/item1.jpg"
    },
    {
      id: "2", 
      name: "Sample Hearty Soups Item 2",
      description: "Premium soups item description made to perfection",
      price: 55.00,
      image: "/images/menu/soups/item2.jpg"
    },
    {
      id: "3",
      name: "Sample Hearty Soups Item 3", 
      description: "Special soups item description with unique flavors",
      price: 65.00,
      image: "/images/menu/soups/item3.jpg"
    }
  ];

  const handleNavigate = (name: string) => {
    const slug = name.replace(/\s+/g, "-").toLowerCase();
    router.push(`/menu/soups/${slug}`);
  };
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Warm, comforting soups made with fresh ingredients and served with artisan bread
          </p>
        </div>
              ...
              >
                <div className="relative w-full h-52">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-[#6C7B58] to-[#8A9B6E] hidden items-center justify-center">
                    <span className="text-white/80 text-sm">Hearty Soups Image</span>
                  </div>
                </div>
