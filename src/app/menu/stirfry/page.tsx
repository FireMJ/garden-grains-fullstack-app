...
export default function StirfryListPage() {
  const router = useRouter();
  const { state } = useCart();

  // TODO: Replace with actual data import for stirfry
  const menuItems = [
    {
      id: "1",
      name: "Sample Asian Stirfry Item 1",
      description: "Delicious stirfry item description with fresh ingredients",
      price: 45.00,
      image: "/images/menu/stirfry/item1.jpg"
    },
    {
      id: "2", 
      name: "Sample Asian Stirfry Item 2",
      description: "Premium stirfry item description made to perfection",
      price: 55.00,
      image: "/images/menu/stirfry/item2.jpg"
    },
    {
      id: "3",
      name: "Sample Asian Stirfry Item 3", 
      description: "Special stirfry item description with unique flavors",
      price: 65.00,
      image: "/images/menu/stirfry/item3.jpg"
    }
  ];

  const handleNavigate = (name: string) => {
    const slug = name.replace(/\s+/g, "-").toLowerCase();
    router.push(`/menu/stirfry/${slug}`);
  };
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Quick, flavorful stirfry dishes packed with fresh vegetables and your choice of protein
          </p>
        </div>
              ...
              >
                <div className="relative w-full h-52">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-[#6C7B58] to-[#8A9B6E] hidden items-center justify-center">
                    <span className="text-white/80 text-sm">Asian Stirfry Image</span>
                  </div>
                </div>
