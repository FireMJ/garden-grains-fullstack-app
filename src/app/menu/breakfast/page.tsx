...
// Use function declaration instead of const for better debugging
  ...
  return (
    <main className="px-4 py-8 text-gray-900 bg-[#1E4259] min-h-screen">
      <div className="flex justify-between items-center mb-6 max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold text-green-600">Breakfast</h1>
        <button
          onClick={() => router.back()}
...
export default BreakfastPage; // Ensure this is the last line