...
export default function PastaDetailPage({ params }: { params: Promise<{ slug: string }> }) {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900 mb-2">{pasta.name}</h1>
            <p className="text-gray-600 mb-4">{pasta.description}</p>
            <div className="text-2xl font-bold text-green-600 mb-6">R{pasta.price}</div>

            {pasta.tags && pasta.tags.length > 0 && (
              <div className="mb-6">
                <div className="flex flex-wrap gap-2">
                  {pasta.tags.map((tag: string, idx: number) => (
