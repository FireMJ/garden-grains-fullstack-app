...
import { toasties } from '@/data/toasties';
...
export default function ToastiesPage() {
  ...
  useEffect(() => {
    ...
    toasties.forEach(toastie => { popularStatus[toastie.id] = isItemPopular(toastie.id, 'toasties'); });
    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Toasties & Sandwiches</h1>
          <p className="text-gray-600 max-w-2xl mx-auto">Grilled to perfection on artisan sourdough bread. Served hot and crispy with your choice of fillings.</p>
          <p className="text-sm text-gray-500 mt-2">✨ Add a portion of skinny fries for R25</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {toasties.map((toastie) => (
            <Link key={toastie.id} href={`/menu/toasties/${toastie.slug}`} className="bg-white rounded-xl shadow hover:shadow-lg transition-all duration-300 overflow-hidden group">
              <div className="relative h-48 bg-gray-100 overflow-hidden">
                ...
                {toastie.tags?.includes('vegetarian') && (
              ...
              <div className="p-5">
                ...
                <div className="flex justify-between items-center mt-3">
                  <div>
                    ...
                    <p className="text-xs text-gray-400">+R25 for fries</p>
                  </div>
